...
//    private static final String zkServerPath = "localhost:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.warn("start connecting zookeeper server ...");
        logger.warn("connect status {}", zooKeeper.getState());
